        ...
        <div class="w-[450px] mx-auto">
            <form method="post" action="{{ route('product.create') }}" enctype="multipart/form-data">
                ...
                <div class="flex justify-between">
                    ...
                    <input type="text" name="nama_barang" id="nama_barang" class="border-2 w-[250px]"/>
                </div>
                <br>
                <div class="flex justify-between">
                    <label for="harga_barang" class="text-slate-900 font-bold"> Harga Barang </label>
                    <input type="number" name="harga_barang" id="harga_barang" class="border-2 w-[250px]"/>
                </div>
                <br>
                <div class="flex justify-between">
                    <label for="stok_barang" class="text-slate-900 font-bold"> Stok Barang </label>
                    <input type="number" name="stok_barang" id="stok_barang" class="border-2 w-[250px]"/>
                </div>
                <br>
                <div class="flex justify-between">
                    <label for="deskripsi_barang" class="text-slate-900 font-bold"> Deskripsi Barang </label>
                    <input type="text" name="deskripsi_barang" id="deskripsi_barang" class="border-2 w-[250px]"/>
                </div>
                <br>
                <div class="flex justify-between">
