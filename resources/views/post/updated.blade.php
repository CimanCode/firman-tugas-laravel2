    ...
    <div class="mx-auto w-[1000px] shadow-xl p-14 mt-20">
        ...
        <div class="w-[700px] mx-auto">
            <form method="post" action="{{ route('post.update', ["id"=>$post->id]) }}"  enctype="multipart/form-data">
                ...
                @csrf
                <div class="flex">
                    <label for="judul" class="text-slate-900 font-bold mr-[50px]"> Title </label>
                    <input type="text" name="judul" id="judul" value="{{ $post->judul }}" class="border-2 w-full"/>
                </div>
                <br>
                <div class="flex">
                    <label for="artikel" class="text-slate-900 font-bold mr-[35px]"> Article </label>
                    <textarea id="artikel" name="artikel"  rows="4" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Write your artikel..." value="{{ $post->artikel }}"></textarea>
                </div>
                <br>
                <div class="flex">
